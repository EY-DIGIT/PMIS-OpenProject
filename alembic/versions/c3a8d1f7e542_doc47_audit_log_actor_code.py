...
Mirrors ``users.user_code`` (e.g. ``US-CHIN-260506120444``) onto the
audit row at write time. NOT NULL with a ``'system'`` fallback for
rows whose actor_id is null or whose user row was deleted.
"""
