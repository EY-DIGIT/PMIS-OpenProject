"""Shared phone-number validation helper.

Used by both the user schema (``app/api/v3/users/schemas.py``) and the
vendor schema (``app/api/v3/vendors/schemas.py``) to apply a consistent
"is this even a phone number?" check on the wire.
