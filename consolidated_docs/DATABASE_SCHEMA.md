...
**Tables on `Base.metadata`**: 37 (was 34 pre-doc-33; doc 33 change 3 added 3 — `notification_log`, `otp_codes`, `password_reset_tokens`; doc 35 dropped 1 — `attachments` merged into `comments.attachments` JSON; doc 36 added 1 — `notification_templates`).
