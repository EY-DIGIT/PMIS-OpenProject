...
Usage (from monolith root, with venv active):
...
``PMIS_API_Collection.postman_collection.json`` at the repo root.
...
Variables in the collection:
    {{baseUrl}}      — root URL, default http://127.0.0.1:8000
        ...
        "variable": [
            {
                ...
                "type": "string",
                "description": "Root URL of the monolith. Override per environment.",
            },
            {
                "key": "accessToken",
                "value": "",
...
def main() -> None:
    ...
    out = REPO_ROOT / "PMIS_API_Collection.postman_collection.json"
