"""Doc 54 — assignee narrowing on tasks / subtasks for non-admin callers.
...
def project(sample_project):
    """Reuse the conftest's sample_project. It's just a row in the
    projects table — we only need a project_id for the validator."""
