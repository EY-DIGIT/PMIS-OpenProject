...
class TestPriorityCatalog:
    ...
    def test_admin_can_add_p4(self, client, admin_user, admin_headers, _seeded_priorities):
        r = client.post(
    ...
    def test_patch_updates_name(self, client, admin_user, admin_headers, _seeded_priorities):
